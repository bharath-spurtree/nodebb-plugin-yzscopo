	...
	var buildAdminPage = function(req, res) {
			async.parallel({
				...
				documentation: function(next) {
					fs.readFile(path.join(__dirname, 'v5/readme.md'), {
						encoding: 'utf-8'
				...
				res.render('admin/plugins/yzscopo', data);
			});
		};

	module.exports = function(app, middleware) {
		app.get('/admin/plugins/yzscopo', middleware.admin.buildHeader, buildAdminPage);
		app.get('/api/admin/plugins/yzscopo', buildAdminPage);
	};
})();
