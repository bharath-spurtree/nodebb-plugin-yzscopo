...
var Users = require.main.require('./src/user'),
	...
	apiMiddleware = require('nodebb-plugin-yzscopo/routes/v5/middleware'),
	errorHandler = require('nodebb-plugin-yzscopo/lib/errorHandler'),
	auth = require('nodebb-plugin-yzscopo/lib/auth'),
	utils = require('nodebb-plugin-yzscopo/routes/v5/utils'),
